...
function SvgArrowRepeatIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      className="arrow-repeat-icon_svg__bi arrow-repeat-icon_svg__bi-arrow-repeat"
      viewBox="0 0 16 16"
      width="1em"
      height="1em"
      aria-hidden="true"
...
export default SvgArrowRepeatIcon;
