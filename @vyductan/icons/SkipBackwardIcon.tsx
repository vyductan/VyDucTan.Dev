...
function SvgSkipBackwardIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      className="skip-backward-icon_svg__bi skip-backward-icon_svg__bi-skip-backward-fill"
      viewBox="0 0 16 16"
      width="1em"
      height="1em"
      aria-hidden="true"
...
export default SvgSkipBackwardIcon;
