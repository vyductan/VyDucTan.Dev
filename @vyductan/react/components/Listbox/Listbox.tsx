...
import { type ElementType, Fragment, type ReactNode, type Ref } from 'react'
        ...
        >
          {Array.isArray(options) ? (
            <HeadlessUIListBox.Options
              className={clsm(
                'absolute z-50 overflow-hidden rounded-base bg-white py-1 font-semibold shadow-lg ring-1 ring-slate-900/10',
